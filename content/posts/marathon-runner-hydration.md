---
title: "マラソンの水分補給｜脱水・電解質・水の選び方を基本から整理"
description: "マラソンで起きやすい脱水・低ナトリウム血症・ミネラル補給の考え方をデータで整理。シリカ72mg/Lなど成分数値も交えて、走る前後の水の選び方がわかります。"
date: "2026-04-03"
category: "プロトン水"
...
hashtags:
  ...
  - 電解質
  - 健康科学ラボ
tweet_title: "マラソンの水分補給｜脱水と電解質の基本"
tweet_points:
  - "水だけでなく電解質と発汗量をセットで考えるのが基本"
  - "失速や脚つりは脱水や低ナトリウム血症とつながりやすい"
tldr:
  - "マラソンの水分補給は、水だけでなく電解質と発汗量をセットで考えるのが基本"
  - "失速や脚つりは、脱水や低ナトリウム血症リスクとつながりやすい"
  - "水を選ぶときは、補給タイミングに加えてミネラル成分も比較材料になる"
faq:
  - question: "マラソンでは水だけ飲めば十分ですか？"
    answer: "十分とは言い切れません。長時間の発汗では水分だけでなくナトリウムなどの電解質も失われるため、補給量、タイミング、ミネラルの考え方をセットで見る方が失速や低ナトリウム血症の予防につながります。"
references:
...
マラソンの水分補給で最初に押さえるべき結論は、**「水だけ飲めばいい」ではなく、発汗量と電解質の損失を前提に補給計画を組む必要がある**ということです。失速や脚つり、レース後の強い倦怠感は、水分管理の設計ミスで起きやすくなります。
...
喉の渇きを感じた時点では、すでに体重の1〜2%の水分が失われているとされます。人体の「渇き」センサーは精度が高くない。だからこそ、**ルールベース（一定間隔・一定量）での補給**がランナーには推奨されます。エンジニアなら、ポーリングではなくスケジューラによる制御、と考えると分かりやすいです。
...
énazuma7のシリカ濃度72mg/Lは、エビアンの約**6.2倍**で、コントレックスよりは低い水準に位置する。
...
<tr><td>硬度</td><td>軟水（硬水より軽い口当たりと感じる人が多い）</td></tr>
</tbody>
</table>
</div>
...
コントレックスはシリカ103.2mg/Lと高い一方で、海外の硬水として知られています。**énazuma7は軟水寄りでシリカが高い**という点が、成分比較上の特徴として挙げられます。
...
<li><a href="/posts/kickboxer-hydration">格闘技選手の水分補給｜計量後リカバリーと水の選び方をデータで整理</a></li>

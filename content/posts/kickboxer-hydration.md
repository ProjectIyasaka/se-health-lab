...
「水をたくさん飲めばいい」という誤解が格闘技の現場では危険だ。電解質が枯渇した状態で純水のみを大量摂取すると、血中ナトリウム濃度がさらに希釈される**低ナトリウム血症**のリスクが生じる。これは頭痛・吐き気・倦怠感として現れ、試合前のコンディションを大きく損ねる。
...
| 成分・項目 | 数値 | 格闘技選手への関連性 |
|---|---|---|
| **シリカ** | 72mg/L | 関節・腱・靱帯のコラーゲン合成への関与（研究進行中） |
| **バナジウム** | 4.7μg/L | 糖代謝・グリコーゲン回復への関与（研究段階） |
| **pH** | 7.3（弱アルカリ性〜中性） | 胃腸への負担が少なく運動前後でも飲みやすい |
| **採水地** | 大分県玖珠町 地下200m | 深層地下水由来のミネラルバランス |
| **硬度** | 軟水 | 日本人の体質に合いやすく、吸収がスムーズとされる |
